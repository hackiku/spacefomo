...
<script lang="ts">
  ...
  // Move these to fomoStore later for better organization
  ...
  <div class="relative ">
    <div class="max-w-[1920px] mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 2xl:px-32">
      <div class="flex gap-2 pb-0.5">
        {#each $fomoStore.weeks as week (week.weekNumber)}
          ...
          <button 
            ...
            on:click={() => {
              fomoStore.setActiveWeek(isActive ? null : week.weekNumber);
            }}
          >
